...
class Venlab_Marker_Calibration(Calibration_Plugin):
    """
    ...
    def init_ui(self):
        super().init_ui()
        self.menu.label = "Venlab Calibration"
    ...
    def recent_events(self, events):
        ...
        surfaces = events.get('surfaces') #See if there is any surface information
